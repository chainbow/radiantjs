...
Base58Check.decode = function (s) {
  ...
  var data = Buffer.from(buf.slice(0, -4))
  var csum = Buffer.from(buf.slice(-4))

  var hash = sha256sha256(data)
  var hash4 = Buffer.from(hash.slice(0, 4))
...
Base58Check.checksum = function (buffer) {
  return sha256sha256(Buffer.from(buffer)).slice(0, 4)
}
